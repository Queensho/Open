...
class SecurityCenterScreen extends StatefulWidget {
  ...
  @override State<SecurityCenterScreen> createState() => _SecurityCenterScreenState();
}

class _SecurityCenterScreenState extends State<SecurityCenterScreen> {
  bool showOnline = true, showDistance = true, discoverable = true;
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: SafeArea(child: ListView(padding: EdgeInsets.zero, children: [
      Container(
        padding: const EdgeInsets.fromLTRB(18,14,18,28),
        decoration: const BoxDecoration(color: ui.OpenApp.lime,borderRadius: BorderRadius.vertical(bottom: Radius.circular(36))),
        child: Column(children: [
          Row(children: [_circle(Icons.arrow_back_rounded,()=>Navigator.pop(context)),const Spacer(),const Text('Güvenlik',style: TextStyle(fontSize:18,fontWeight:FontWeight.w900)),const Spacer(),const SizedBox(width:46)]),
      ...
      Padding(padding:const EdgeInsets.fromLTRB(18,22,18,30),child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
  ...
  Widget _tile(IconData icon,String title,String sub,VoidCallback tap)=>Container(
  ...
  Widget _switchTile(IconData icon,String title,String sub,bool value,ValueChanged<bool> change)=>Container(
    margin:const EdgeInsets.only(bottom:10),
    decoration:BoxDecoration(color:ui.OpenApp.soft,borderRadius:BorderRadius.circular(24)),
    child:SwitchListTile(
      ...
      activeTrackColor:ui.OpenApp.lime,

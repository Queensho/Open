...
class _PhoneLoginScreenState extends State<PhoneLoginScreen> {
  ...
  void sendCode() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => OtpScreen(phone: phone.text.trim())),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              FilledButton(
                onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const LockQuestionsScreen()),
                ),
...
class _DiscoverScreenState extends State<DiscoverScreen> {
  final profiles = const [
    ...
    LockedProfile(
      ...
      questions: [
        'Son anda aldığın en güzel karar neydi?',
        'Bir şarkı seni hangi ana götürür?',
        'İlk buluşmada en çok neye dikkat edersin?',
      ],
    ...
    LockedProfile(
      ...
      questions: [
        'Hafta sonu senin için mükemmel nasıl geçer?',
        'Birine hemen güvenmeni sağlayan şey?',
        'Seni gerçekten heyecanlandıran şey ne?',
      ],
              ...
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      height: 54,
                      decoration: BoxDecoration(
                        color: OpenApp.lime.withValues(alpha: .18),
                        borderRadius: BorderRadius.circular(18),
                      ),
                      child: const Center(child: AppSvg(AppIcons.profile, size: 38)),
                    ),
                    const SizedBox(width: 14),
                    const Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Merhaba 👋', style: TextStyle(fontSize: 25, fontWeight: FontWeight.w900)),
                          SizedBox(height: 3),
                          Text('Yeni bir kilit keşfet', style: TextStyle(color: OpenApp.muted, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                    Stack(
                      ...
                      children: [
                        ...
                        const Positioned(
                          right: 8,
                          top: 7,
                          child: CircleAvatar(radius: 5, backgroundColor: Color(0xFFFF4C68)),
                        ),
                      ],
                    ),
                  ],
                        ...
                        children: [
                          Positioned(
                            ...
                            child: Transform.rotate(
                              angle: .08,
                              child: Container(
                                height: cardHeight * .74,
                                decoration: BoxDecoration(
                                  color: profiles[(profileIndex + 2) % profiles.length].color,
                          ...
                          Positioned(
                            ...
                            child: Transform.rotate(
                              angle: -.05,
                              child: Container(
                                height: cardHeight * .79,
                                decoration: BoxDecoration(
                                  color: profiles[(profileIndex + 1) % profiles.length].color,
                                      ...
                                      children: [
                                        Center(
                                          child: Column(
                                            mainAxisSize: MainAxisSize.min,
                                            children: [
                                              const AppSvg(AppIcons.lock, size: 116, card: true),
                                              const SizedBox(height: 16),
                                              Text(
                                                profile.bio,
                                                textAlign: TextAlign.center,
                ...
                Row(
                  ...
                  children: [
                    ...
                    _RoundAction(
                      color: OpenApp.lime,
                      child: const AppSvg(AppIcons.key, size: 34),
          ...
          child: SafeArea(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                Text(
                  '${profile.name} için bir kilit sorusu seç',
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => AnswerScreen(profile: profile, question: question),
                          ),
                        );
                      },
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            const AppSvg(AppIcons.question, size: 26),
                            const SizedBox(width: 12),
                            Expanded(
                              child: Text(question, style: const TextStyle(fontWeight: FontWeight.w700)),
                            ),
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: SizedBox(
          width: 74,
          height: 74,
          child: Center(child: child ?? Icon(icon, size: 40, color: Colors.white)),
        ),
      ),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              Text(
                '${widget.profile.name} için anahtarını oluştur.',
              ...
              FilledButton(
                onPressed: () => Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (_) => KeySentScreen(name: widget.profile.name)),
                ),
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.center,
        ...
        child: Column(
          ...
          children: [
            ...
            for (final item in const [
              ('Ece', '“Kahve, sahil ve uzun bir yürüyüş.”'),
              ('Selin', '“Bence iyi bir gün plansız başlayandır.”'),
            ])
              Padding(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    trailing: FilledButton(
                      ...
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => MatchScreen(name: item.$1)),
                      ),
                      child: const Text('Aç'),
                    ),
                  ),

...
class AssetSvg extends StatelessWidget {
  const AssetSvg(this.path, {super.key, this.size = 126});
  final String path;
  final double size;
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  gradient: RadialGradient(
                                    colors: [
                                      OpenApp.lime.withValues(alpha: .17),
                                      OpenApp.lime.withValues(alpha: .025),
                                      Colors.transparent,
                                    ],
                                  ),
                                ),
        ...
        body: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Spacer(),
                const AssetSvg('assets/icons_svg/splash_logo.svg', size: 82),
                const SizedBox(height: 26),
                const Text(
                  'Open',
                  style: TextStyle(

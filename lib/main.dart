              ...
              children: [
                ...
                FilledButton(
                  ...
                  child: const Row(
                    ...
                    children: [AppSvg(AppIcons.phone, size: 23), SizedBox(width: 10), Text('Telefon ile devam et')],
                  ),
                ),
                const SizedBox(height: 12),
                OutlinedButton(
                  ...
                  child: const Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [AppSvg(AppIcons.mail, size: 23), SizedBox(width: 10), Text('E-posta ile devam et')],
                  ),
                ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Center(
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [AppSvg(AppIcons.camera, size: 52), SizedBox(height: 10), Text('Fotoğraf ekle', style: TextStyle(fontWeight: FontWeight.w800))],
                    ),
                  ),
                ),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: OpenApp.soft, borderRadius: BorderRadius.circular(18)),
                    child: Text('${profileIndex + 1}/${profiles.length}', style: const TextStyle(fontWeight: FontWeight.w900)),
                  ),
                ],
              ),
              const SizedBox(height: 18),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Expanded(child: Center(child: AppSvg(AppIcons.lock, size: 118, card: true))),
                        ...
                        Expanded(
                          child: ListView.separated(
                            ...
                            itemCount: profile.questions.length,
                            separatorBuilder: (_, __) => const SizedBox(height: 9),
                            itemBuilder: (_, i) {
                              final active = i == questionIndex;
                              return InkWell(
                                onTap: () => setState(() => questionIndex = i),
                                borderRadius: BorderRadius.circular(18),
                                child: AnimatedContainer(
                                  duration: const Duration(milliseconds: 180),
                                  padding: const EdgeInsets.all(15),
                                  decoration: BoxDecoration(
                                    color: active ? OpenApp.lime.withValues(alpha: .18) : Colors.white,
                                    borderRadius: BorderRadius.circular(18),
                                    border: Border.all(color: active ? OpenApp.lime : const Color(0xFFE5E5E2), width: active ? 2 : 1),
                                  ),
                                  child: Row(
                                    children: [
                                      AppSvg(active ? AppIcons.key : AppIcons.question, size: 26),
                                      const SizedBox(width: 12),
                                      Expanded(child: Text(profile.questions[i], style: TextStyle(fontWeight: active ? FontWeight.w800 : FontWeight.w600))),
                                    ],
                                  ),
                                ),
                              );
                        ...
                        FilledButton(
                          onPressed: () => Navigator.push(
                            context,
                            MaterialPageRoute(builder: (_) => AnswerScreen(profile: profile, question: profile.questions[questionIndex])),
                          ),
                          child: const Text('Bu soruyu cevapla'),
                        ),
                      ],
                    ),
                  ),
              ...
              Row(
                ...
                children: List.generate(
                  ...
                  (i) => AnimatedContainer(
                    ...
                    width: i == profileIndex ? 24 : 8,
                    height: 8,
                    decoration: BoxDecoration(
                      color: i == profileIndex ? OpenApp.lime : const Color(0xFFD8D8D4),
                      borderRadius: BorderRadius.circular(10),
                    ),
                  ),
                ),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(widget.question, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
                ),
                const SizedBox(height: 14),
                ...
                FilledButton(
                  ...
                  child: const Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [AppSvg(AppIcons.key, size: 26), SizedBox(width: 10), Text('Anahtarı gönder')],
                  ),
                ),
              ],
            ),
                    ...
                    children: [
                      Align(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(color: OpenApp.soft, borderRadius: BorderRadius.circular(18)),
                          child: const Text('Selam! Cevabını sevdim 😊'),
                        ),
                      ),
                      ...messages.map(
                        (m) => Align(
